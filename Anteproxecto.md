...
>#### Recursos materiais (durante 1 año)
...
> Cheguei á conclusión de que o mellor modelo de negocio sería Product-as-a-Service.
> O principal produto é a plataforma web, esta ofrece un servicio aos usuarios, tanto a nutricionistas/dietistas como aos seus pacientes.
> Os usuarios (nutricionistas) non compran directamente a páxina web, senón que pagan unha suscripción.
> Pódese acceder desde calquera dispositivo, sempre e cando se dispoña de internet.
> A páxina web está pensada para ampliar novas funcionalidades en base ás necesidades dos seus usuarios principais (nutricionistas).
>
> Os beneficios cos que consta este modelo de negocio son:
...
> 
> O que podería pasar no proceso de creación da páxina web é que ao implementar unha funcionalidade, esta non funcione correctamente, xa sexa pola súa dificultade, ou pola existencia doutras funcionalidades xa implementadas e haxa problemas de compatibilidade. 
